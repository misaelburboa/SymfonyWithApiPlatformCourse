    ...
    protected function getRandomUserReference($entity):User
    {
        ...
        if ($entity instanceof BlogPost && !count(
            array_intersect(
                ...
                // if there's no coincidence enter the same function again 
                // to try to get a user which have permissions to write
                // this will also apply for comments later
